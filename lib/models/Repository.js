    ...
    return {
        ...
        get buildStartedAt () {
            if (_buildStartedAt === undefined) {
                _buildStartedAt = _data.last_build_started_at !== null ? new Date(_data.last_build_started_at) : null;
            }
        ...
        get buildFinishedAt () {
            if (_buildFinishedAt === undefined) {
                _buildFinishedAt = _data.last_build_finished_at !== null ? new Date(_data.last_build_finished_at) : null;
            }
